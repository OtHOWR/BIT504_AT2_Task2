...
public class Board {
	...
	public boolean isDraw() {
		...
		// Use a nested loop to check whether any of the cells content in the board grid are Player.Empty. If they are, it is not a draw.
	...
	public boolean hasWon(Player thePlayer, int playerRow, int playerCol) {
		...
		if(cells[playerRow][0].content == thePlayer && cells[playerRow][1].content == thePlayer && cells[playerRow][2].content == thePlayer )
			return true; 
		 // Check if the player has 3 in the playerCol.  DONE
